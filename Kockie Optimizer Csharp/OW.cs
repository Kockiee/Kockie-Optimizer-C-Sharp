...
namespace Kockie_Optimizer_Csharp
{
    public partial class OW : Form
    {
        ...
        private void btnOptimizewindows_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnOptimizewindows2_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnUndodefender_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Defender are deactivated");
            }
            catch
            {
                MessageBox.Show("Fatal Error on try this action.");
        ...
        private void btnActivatedefender_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Defender are actived");
            }
            catch
            {
                MessageBox.Show("Fatal Error on try this action.");
